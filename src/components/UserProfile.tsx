...
const UserProfile = ({ userId }: UserProfileProps) => {
  const profile = useQuery(api.users.getUserById, userId ? { userId: userId as Id<"users"> } : 'skip');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        {isSelf && (
          <>
            <Link href={`/(auth)/(modal)/edit-profile?biostring=${profile?.bio ? encodeURIComponent(profile?.bio) : ''
